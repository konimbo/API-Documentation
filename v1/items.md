...
יש לשים לב שהלינק לתמונה ניתן לגישה, ניתן לבדוק זאת ע"י גישה לתמונה דרך הדפדפן.
...
שם השדה | סכמה | חובה | הסבר
:---|:---|---:|---:
id | Integer | לא | מספר השורת מפרט בקונימבו, יש לספק את מספר השורת מפרט רק אם ברצונך לערוך או למחוק אותה
